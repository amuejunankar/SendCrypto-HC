...
<body class="body">
  ...
  <div class="container">
    ...
    <div class="form-group">
      <div class="input-group">
        <input type="text" class="toAddressInput" placeholder="Enter ETH Address" oninput="validateEthAddress(this)">
        <p id="error-message" style="display: none; color: red;">Please enter a valid ETH address.</p>
        <br>
  ...
  <!-- to check eth address valid or not -->

  <script>
    function validateEthAddress(input) {
      var ethAddress = input.value;
      var ethAddressRegex = /^(0x)?[0-9a-fA-F]{40}$/;

      if (!ethAddressRegex.test(ethAddress)) {
        // Show error message or perform other validation logic
        document.getElementById('error-message').style.display = 'block';
      } else {
        // Hide error message or continue with other actions
